...
inline bool operator!=(const h7l::runtime::StringRef& ref1,
                       const h7l::runtime::StringRef& ref2){
...
inline h7l::runtime::StringRef operator+(const h7l::runtime::StringRef& ref1,
                               const h7l::runtime::StringRef& ref2){
    auto ret = ref1.copy();
    ret.append(ref2);
    return ret;
